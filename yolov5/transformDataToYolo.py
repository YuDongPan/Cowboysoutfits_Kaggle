...
# todo 修改为你的数据的根目录
FILE_ROOT = "E:/holiday/cow/"

IMAGE_SET_ROOT = FILE_ROOT + "VOC2012/ImageSets/Main"  # 图片区分文件的路径
IMAGE_PATH = FILE_ROOT + "VOC2012/JPEGImages"  # 图片的位置
ANNOTATIONS_PATH = FILE_ROOT + "VOC2012/Annotations"  # 数据集标签文件的位置
LABELS_ROOT = FILE_ROOT + "VOC2012/Labels"  # 进行归一化之后的标签位置

DEST_IMAGES_PATH = "cow_yolo_dataset/score/images"  # 区分训练集、测试集、验证集的图片目标路径
DEST_LABELS_PATH = "cow_yolo_dataset/score/labels"  # 区分训练集、测试集、验证集的标签文件目标路径

# todo 修改为你数据集的标签名称
label_names = ["belt", "sunglasses", "boot", "cowboy_hat", "jacket"]
