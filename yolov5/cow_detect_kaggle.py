...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp4/weights/best.pt',  # 设置模型位置
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/data/nextcloud/dbc2017/files/jupyter/Cowboyoutfit/dataset/cow_yolo_dataset/test_val/val',  # todo 设置验证集图片位置
